...
Extracting the 10 most recent messages per unique combination of (receiver_type, method_num, exit_code), between epochs 2678400 and 2680000:
...
with uniq_msgs as (
    ...
    where messages.height > 2659840 and messages.height < 2680000
